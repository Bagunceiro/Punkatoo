...
bool MQTTController::subscribe(MQTTClientDev *dev, MQTTTopic &topic)
{
...
void MQTTController::publish(String &topic, String &msg)
{
    if (client->connected())
    {
...
void MQTTController::msgRecd(const String &topic, const String &msg)
{
